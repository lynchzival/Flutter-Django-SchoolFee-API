...
class CourseInsert extends StatefulWidget {
  const CourseInsert({Key? key}) : super(key: key);

  @override
  State<CourseInsert> createState() => _CourseInsertState();
}

class _CourseInsertState extends State<CourseInsert> {
  static String get _url {
    return "${Properties.BASE_URL}/course/create/";
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Course Insert'),
      ),
  ...
  void initState() {
    ...
    _webView = WebView(
      ...
      navigationDelegate: (request) {
        if (request.url.contains("${Properties.BASE_URL}/course/")) {
