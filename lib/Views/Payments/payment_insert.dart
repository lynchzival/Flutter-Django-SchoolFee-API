...
class PaymentInsert extends StatefulWidget {
  const PaymentInsert({Key? key}) : super(key: key);

  @override
  State<PaymentInsert> createState() => _PaymentInsertState();
}

class _PaymentInsertState extends State<PaymentInsert> {
  static String get _url {
    return "${Properties.BASE_URL}/payment/create/";
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Payment Insert'),
      ),
